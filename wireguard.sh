...
aria2c -c -t 10 -s 100 -o wireguard-windows-latest-amd64.msi ${WG_WINDOWS_PATH}${WG_WINDOWS_AMD64}
WG_WINDOWS_ARM64=$(curl -s ${WG_WINDOWS_PATH} | cut -d '"' -f 6)
aria2c -c -t 10 -s 100 -o wireguard-windows-latest-arm64.msi ${WG_WINDOWS_PATH}${WG_WINDOWS_ARM64}
WG_WINDOWS_X86=$(curl -s ${WG_WINDOWS_PATH} | cut -d '"' -f 6)
aria2c -c -t 10 -s 100 -o wireguard-windows-latest-x86.msi ${WG_WINDOWS_PATH}${WG_WINDOWS_X86}
...
aria2c -c -t 10 -s 100 -o wireguard-android-latest.apk ${WG_ANDROID_URL} 
